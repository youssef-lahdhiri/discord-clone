...
const ServerSearch = ({ data }: ServerSearchProps) => {
  ...
  const onClick = ({
    ...
    if (type === "channel") {
      router.push(`/server/${params?.id}/channels/${id}`);
    }
  };
  return (
    <>
...
"
      >
        ...
        <kbd
          className="pointer-event-none inline-flex h-5 select-none items-center
...
"
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <CommandInput placeholder="search all channels and memver " />
        <CommandList>
